...
export class ShortcutSettingsView extends LitElement {
    static styles = css`
        * { font-family:'Helvetica Neue',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;
        ...
        .titlebar{display:flex;align-items:center;gap:8px;margin:0 0 8px;padding-bottom:8px;
            border-bottom:1px solid rgba(255,255,255,.1);}
        .titlebar .spacer{inline-size:14px;flex:0 0 auto;}
        .close-button{flex:0 0 auto;inline-size:14px;block-size:14px;padding:0;
