...
module.exports = {
  ...
  initialize() {
    ...
    ipcMain.handle('settings:get-record-listen', async () => await settingsService.getRecordListenSetting());
    ipcMain.handle('settings:set-record-listen', async (event, isEnabled) => await settingsService.setRecordListenSetting(isEnabled));
    ipcMain.handle('settings:open-recordings-folder', async () => await settingsService.openRecordingsFolder());
    ipcMain.handle('settings:get-filter-them-audio', async () => await settingsService.getFilterThemAudioSetting());
    ipcMain.handle('settings:set-filter-them-audio', async (event, isEnabled) => await settingsService.setFilterThemAudioSetting(isEnabled));
    ...
    ipcMain.handle('ask:clearResponse',   async () => await askService.clearResponse());
    ...
    ipcMain.handle('platform:get-invisibility-support', () => require('../features/common/utils/platformSupport').getInvisibilitySupport());
